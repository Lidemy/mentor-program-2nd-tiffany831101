                    ...
                    {boxArr.map((num) => {
                        return (
                            <div className="col-lg-5 col-md-5 col-12 about__banner_box mx-3 mt-4">
                                <img className="mt-3" src="https://images.pexels.com/photos/109919/pexels-photo-109919.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=350" alt="" />
                                <p className="mt-2">this is about tech</p>
