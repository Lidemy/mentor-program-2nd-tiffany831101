        ...
        return (
            <>
                    ...
                    {boxArr.map((num) => {
                        return (
                            <div className="col-lg-5 col-md-5 col-12 about__banner_box mx-3 mt-4">
                                <img className="mt-3" src="https://images.pexels.com/photos/886465/pexels-photo-886465.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=350" alt="" />
                                <p className="mt-2">this is about business</p>
                ...
                <div className="col-lg-4 col-md-4 col-4 float-right about__banner_right mt-5">
                    <h5 className="col-lg-10 col-md-10 col-10 text-center mx-auto">MORE WRITING ON TECH</h5>
